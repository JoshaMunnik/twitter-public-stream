...
Stream.prototype.stream = function () {
  ...
  this.m_request.on('response', (response) => {
    if (response.statusCode > 200) {
      ...
      response.on('data', (chunk) => {
        ...
        while (true) {
          ...
          // either line text is the length of the data or the data itthis
          if (getLength) {
